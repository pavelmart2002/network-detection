...
logger = logging.getLogger("circular_view")

class CircularView(QWidget):
    """Простой виджет с круговой диаграммой для отображения направления на источник атаки"""
    ...
    def __init__(self, parent=None):
        ...
        logger.info("CircularView initialized")
